...
import { IERC20, IWETH, IUniswapV2Pair } from '../../typechain';
...
//#region transfers
export const sendEtherTo = (address: string, amount: BigNumber = getBigNumber(10)) => withSigner(WETH, async (signer) => {
